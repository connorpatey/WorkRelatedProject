...
using WorkRelatedProject.Models;

namespace WorkRelatedProject.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CustomerID,FirstName,Surname,MaritalStatus,ContactNumber,EmailAddress,DateOfBirth,AddressID")] Customer customer)
        {
